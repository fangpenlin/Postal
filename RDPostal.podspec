Pod::Spec.new do |s|
  ...
  s.license = 'MIT'
  s.author = { 'Fang-Pen Lin' => 'hello@fangpenlin.com', 'Kevin Lefevre' => 'kevin.lefevre@snips.ai', 'Jeremie Girault' => 'jeremie.girault@gmail.com' }
  s.swift_version = '5.0'

  s.ios.deployment_target = '8.0'
  s.osx.deployment_target = '10.10'

  s.source = { :git => 'https://github.com/fangpenlin/Postal.git', :tag => 'v' + s.version.to_s }
